...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        .then(function (response) {
            ...
            document.getElementById('submitBtn').innerHTML = 'Gửi';
            clearInput()
            //handle success
            ...
            <div className="flex justify-center items-center mt-8 w-full bg-white py-12 lg:py-24 bg-gray-200">
                ...
                <form onSubmit={sendEmail}>
                    ...
                    <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                        <div className="flex">
                            <h1 className="font-bold text-center lg:text-left text-[#262626] uppercase text-4xl">Gửi Lời Nhắn Cho Chúng Tôi</h1>
                        </div>
                        ...
                        <div className="my-2 w-1/2 lg:w-2/4">
                            <button type="submit" id="submitBtn" className="uppercase text-sm font-bold tracking-wide bg-[#F58320] hover:bg-orange-600 text-gray-100 p-3 rounded-lg w-full 
                        ...
                        <div
                            className="w-full  lg:-mt-96 lg:w-2/6 px-8 py-6 ml-auto bg-[#2E3D76] rounded-2xl">
                            <div className="flex flex-col text-white">
                                ...
                                <div className="flex my-4 w-2/3 lg:w-3/4">
                                    ...
                                    <div className="flex flex-col">
                                        <h2 className="text-2xl">Trụ sở chính</h2>
                                        <p className="text-gray-400">33 Khu dân cư Phú Long, Nguyễn Hữu Thọ, Phước Kiển, Nhà Bè, TP.Hồ Chí Minh</p>
                                    </div>
                                </div>
