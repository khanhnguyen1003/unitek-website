            ...
            <div className="hero" id='hero'>
                ...
                <div className="m-auto overflow-hidden h-5/6" data-aos="zoom-in">
                    ...
                    <div className="flex flex-col lg:flex-row justify-between text-center lg:text-left">
                        ...
                        <div className='absolute w-[55%] h-full items-center flex pl-[108px]'>
                            <div>
                                <h1 className="mb-5 md:text-5xl text-3xl font-bold text-[#262626]">
                                    Không có công nghệ tốt nhất, chỉ có công nghệ phù hợp
                                </h1>
                                <p className='text-xl font-normal tracking-tight mb-5 text-gray-500'>Unicube giải quyết nhu cầu của các bạn bằng những giải pháp tối ưu nhất.</p>
